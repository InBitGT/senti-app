...
import { ModalSupplierDetail } from "@/components/molecules/ModalSupplier/ModalSupplier";
...
export const Supplier: React.FC = () => {
  ...
  const [modalData, setmodalData] = useState<SupplierDetail | undefined>(
    undefined,
  );
  ...
  const hadleModalData = (data: SupplierDetail) => {
